...
[![CRAN Version](http://www.r-pkg.org/badges/version/IRCcheck)](https://cran.r-project.org/package=IRCcheck)
[![Downloads](https://cranlogs.r-pkg.org/badges/IRCcheck)](https://cran.r-project.org/package=IRCcheck)
[![CircleCI build status](https://circleci.com/gh/donaldRwilliams/IRCcheck.svg?style=shield)](https://circleci.com/gh/donaldRwilliams/IRCcheck)
...
examine the infinity norm (must be less than 1). Below, `gen_net`
generates a true network, or GGM, with partial correlations
in a certain range (`lb` and `ub`).
...
high. On the other hand, the non-regularized method based on good old
